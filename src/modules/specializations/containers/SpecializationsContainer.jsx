...
import CreateEditRegion from "../components/CreateEditSpecializations.jsx";
...
const SpecializationsContainer = () => {
    ...
    const {data,isLoading} = usePaginateQuery({
        key: KEYS.specializations_list,
        url: URLS.specializations_list,
        params: {
            params: {
                size: 10,
                search: searchKey
    ...
    const useDelete = (id) => {
        mutate({url: `${URLS.specializations_delete}/${id}`})
    }
